...
public final class FragmentAddTransactionBinding implements ViewBinding {
  ...
  private FragmentAddTransactionBinding(@NonNull ScrollView rootView,
      ...
      @NonNull TextInputEditText etCategory, @NonNull TextInputEditText etNote,
      @NonNull RadioButton rbExpense, @NonNull RadioButton rbIncome, @NonNull RadioGroup rgType) {
  ...
  public static FragmentAddTransactionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAddTransactionBinding((ScrollView) rootView, btnSave, etAmount, etCategory,
          etNote, rbExpense, rbIncome, rgType);
    }
